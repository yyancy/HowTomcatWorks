...
public final class Bootstrap {
    public static void main(String[] args) {
        ...
        System.setProperty("catalina.base", System.getProperty("user.dir") + File.separator + "how-tomcat-works-ex09");
        ...
        HttpSession session = (HttpSession)manager.createSession();
